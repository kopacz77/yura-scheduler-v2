...
export default function HomePage() {
  return (
    <div className="min-h-screen bg-gradient-to-b from-white to-slate-50">
      ...
      {/* Hero Section */}
      <section className="flex min-h-[600px] items-center justify-center pt-16 pb-12 md:min-h-[700px] md:pt-24 md:pb-20">
        <div className="container mx-auto px-4 text-center">
          <Logo size="large" className="mx-auto mb-8" />
          <h1 className="mx-auto max-w-4xl text-4xl font-bold tracking-tight text-slate-900 sm:text-5xl md:text-6xl lg:text-7xl">
      ...
      <section className="container mx-auto px-4 pb-20">
        <div className="grid gap-8 sm:grid-cols-2 lg:grid-cols-3">
          ...
          <div className="group relative overflow-hidden rounded-2xl bg-white p-8 shadow-md ring-1 ring-slate-200 transition-all hover:shadow-lg">
            ...
            <div className="absolute right-0 top-0 -mr-16 -mt-16 h-32 w-32 rounded-full bg-purple-50 transition-all group-hover:bg-green-100" />
          </div>
        </div>
      </section>
    </div>
